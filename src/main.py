...
# Hyperparameters 
N_VALUES = [50]
n_TRAIN_VALUES = [1000, 10000]
n_TEST = 10000
NUM_EXP = 10 # The number of experiments for each (N,n_train) tuple. In each experiment we use a new training dataset but the same testing dataset (V remains the same)
DEVICE_TYPE = 'cpu'
